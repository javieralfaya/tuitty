 ...
 */
class Award extends \tuitty\TuittyBundle\Document\Award implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'tuittyId', 'categoryId', 'active');
    }
