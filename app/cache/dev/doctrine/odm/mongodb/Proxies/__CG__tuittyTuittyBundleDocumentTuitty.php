 ...
 */
class Tuitty extends \tuitty\TuittyBundle\Document\Tuitty implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getEthnicityId();
    }

    public function setEthnicityId($ethnicityId)
    {
        $this->__load();
        return parent::setEthnicityId($ethnicityId);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'userId', 'name', 'ethnicityId', 'pedigree', 'registrationDate', 'age', 'active');
    }
