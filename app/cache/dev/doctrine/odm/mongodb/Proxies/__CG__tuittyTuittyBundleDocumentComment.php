 ...
 */
class Comment extends \tuitty\TuittyBundle\Document\Comment implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'userId', 'registrationDate', 'content', 'active');
    }
